...
<div class="section-content section-dashboard-home" data-aos="fade-up">
  <div class="container-fluid">
    <div class="dashboard-headig">
      <h2 class="dashboard-title">Admin Dashboard</h2>
      <p class="dashboard-title">
          This is Ecoliv Administrator Panel
      </p>
    </div>
        ...
        <div class="dashboard-content">
          ...
          <div class="row mt-3">
                  <div class="col-12 mt-2">
                    ...
                    <a href="{{ route('admin-dashboard-transactions-details', $transaction->id) }}" class="card card-list d-block">
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-1">
                            <img 
                          ...
                          <div class="col-md-3">{{ $transaction->transaction->transactions_status }}</div>
